...
FloatMatrixType Amoeba(RayCastCostFunction &cf,int iter);
FloatMatrixType Powell(RayCastCostFunction &cf, double stepsize);
FloatMatrixType LBFGS(RayCastCostFunction &cf);
FloatMatrixType Biplane(RayCast &X, int method, int metric, vector<float> stepsizes);
FloatMatrixType Monoplane(RayCast &X, int method, int metric, vector<float> stepsizes);
...
int main(int argc, char* args[] ){
    ...
    if(argc < 5)
    {
        printf("Proper usage: RayCast [parameterfile] [logfile] [OptAlgorithm (1=Amoeba 2=Powell 3=LFBGS)] [Similarity Metric (1=NCC 2= Gradient NCC)] ]\n");
        return -1;
    }
...
FloatMatrixType Biplane(RayCast &X, int method, int metric,vector<float> stepsizes)
{
    ...
    RayCastCostFunction cf12___6(3);cf12___6.SetRayCast(&X);cf12___6.SetGradient(usegradient);
    RayCastCostFunction cf12_456(5);cf12_456.SetRayCast(&X);cf12_456.SetGradient(usegradient);
    RayCastCostFunction cf123456(6);cf123456.SetRayCast(&X);cf123456.SetGradient(usegradient);
    ...
    if( method == 1)
    {
        ...
        log = Amoeba(cf12_456, 250); logs.push_back(log);
